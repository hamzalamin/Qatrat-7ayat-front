  ...
  const processSteps = [
    {
      ...
      description: "ملء استمارة بسيطة والخضوع لفحص طبي مبدئي للتأكد من أهليتك للتبرع",
      duration: "10-15 دقيقة",
      details: "يتم قياس ضغط الدم، النبض، درجة الحرارة، ونسبة الهيموجلوبين في الدم"
    },
    {
      title: "عملية التبرع",
      ...
      duration: "8-10 دقائق",
      details: "تتم العملية على يد متخصصين باستخدام معدات معقمة تستخدم لمرة واحدة"
    },
    {
      title: "فترة الراحة",
      icon: <Coffee className="w-6 h-6" />,
      description: "استراحة قصيرة مع تناول المشروبات والوجبات الخفيفة لاستعادة النشاط",
      duration: "10-15 دقيقة",
    ...
    },
    {
      ...
      description: "يتم فحص الدم وفصله إلى مكوناته الأساسية لتلبية احتياجات مختلف المرضى",
      duration: "24 ساعة",
      details: "يمكن فصل الدم إلى خلايا حمراء، صفائح دموية، وبلازما لمساعدة عدة مرضى"
    },
    {
      title: "إنقاذ الأرواح",
      icon: <Heart className="w-6 h-6" />,
      description: "وصول تبرعك لمن يحتاجه من المرضى في المستشفيات ومراكز الرعاية",
      duration: "خلال أسبوع",
  ...
  const faqs = [
    {
      ...
      answer: "يمكن للأشخاص الأصحاء بين 18 و60 عاماً، ممن يزنون أكثر من 50 كجم، التبرع بالدم. يجب أن تكون بصحة جيدة وألا تعاني من أمراض معدية أو مزمنة خطيرة. هناك بعض الحالات التي قد تمنع التبرع مؤقتاً مثل الحمل، العمليات الجراحية الحديثة، أو تناول بعض الأدوية."
    },
    {
      id: 2,
      question: "كم مرة يمكنني التبرع بالدم؟",
      answer: "يمكن للرجال التبرع كل 3 أشهر (4 مرات سنوياً)، بينما يمكن للنساء التبرع كل 4 أشهر (3 مرات سنوياً). هذه الفترة ضرورية للسماح للجسم باستعادة مخزون الحديد والخلايا الدموية."
    },
    {
      id: 3,
      question: "هل التبرع بالدم آمن؟",
      answer: "نعم، عملية التبرع بالدم آمنة تماماً. يتم استخدام معدات معقمة تُستخدم لمرة واحدة فقط، مما يمنع أي خطر للعدوى. الكمية المسحوبة آمنة ويستطيع الجسم تعويضها خلال فترة قصيرة. يشرف على العملية فريق طبي متخصص."
    },
    {
      id: 4,
      question: "ماذا يجب أن أفعل قبل التبرع بالدم؟",
      answer: "ينصح بتناول وجبة متوازنة قبل 3 ساعات من التبرع، وشرب كمية كافية من الماء (2-3 أكواب على الأقل). تجنب الدهون والأطعمة الثقيلة. احرص على النوم جيداً ليلة التبرع. أحضر هويتك الشخصية وقائمة بالأدوية التي تتناولها إن وجدت."
    },
    {
      id: 5,
      question: "هل هناك آثار جانبية للتبرع بالدم؟",
      answer: "معظم المتبرعين لا يشعرون بأي آثار جانبية سوى وخز بسيط عند إدخال الإبرة. في حالات نادرة، قد يشعر البعض بدوار خفيف أو ضعف مؤقت يزول بالراحة وتناول السوائل. من النادر جداً حدوث مضاعفات. سيقدم لك الفريق الطبي كافة النصائح للتعافي السريع."
    }
  ];
  ...
  const myths = [
    {
      ...
      reality: "التبرع بالدم لا يؤثر على الوزن، بل قد يحفز الجسم على إنتاج خلايا دم جديدة وصحية"
    },
    {
      myth: "التبرع بالدم يضعف الجسم لفترة طويلة",
      reality: "يستعيد الجسم السوائل خلال 24 ساعة والخلايا الحمراء خلال أسابيع قليلة"
    },
    {
      myth: "المرأة لا يمكنها التبرع أثناء الدورة الشهرية",
      reality: "يمكن للمرأة التبرع خلال الدورة الشهرية طالما أن مستوى الهيموجلوبين طبيعي"
    },
    {
      myth: "التبرع يؤدي للإصابة بفقر الدم",
      reality: "يتم التأكد من مستويات الهيموجلوبين قبل كل تبرع، ولا يُسمح بالتبرع لمن يعاني من نقص الحديد"
    }
  ];
    ...
    <section dir="rtl" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-bold font-cairo text-neutral-800 mb-4">
            رحلة قطرة الدم
          </h2>
          <p className="text-neutral-600 font-ibm max-w-2xl mx-auto">
            تعرف على المراحل البسيطة التي تمر بها عملية التبرع بالدم من لحظة وصولك حتى إنقاذ حياة شخص آخر
          </p>
        </div>
          ...
          <div className="lg:col-span-2 bg-neutral-50 rounded-xl p-6 shadow-md">
            ...
            <ul className="space-y-3 mt-4">
              {[
                ...
                <li key={idx} className="flex items-center text-neutral-700 font-ibm text-sm">
            ...
            <div className="space-y-3">
              {faqs.map((faq) => (
                <div key={faq.id} className="border border-neutral-200 rounded-lg overflow-hidden">
                  ...
                  >
                    <span className="font-cairo font-medium text-neutral-800">{faq.question}</span>
                    <ChevronDown 
              ...
              <div key={idx} className="bg-white rounded-lg p-4 shadow-sm">
                <div className="bg-secondary-50 rounded-lg p-3 mb-3">
                  <p className="text-secondary-700 font-cairo font-medium text-sm">
                    <span className="text-secondary-500 font-bold ml-1">الخرافة:</span>
                    {item.myth}
                  </p>
                </div>
                <div className="bg-primary-50 rounded-lg p-3">
                  <p className="text-primary-700 font-ibm text-sm">
                    <span className="text-primary-500 font-bold ml-1">الحقيقة:</span>
                    {item.reality}
                  </p>
                </div>
              </div>
