...
import { Check, X, Eye, Search, ChevronLeft, ChevronRight, AlertCircle } from 'lucide-react';
import ArticleService from '../../services/articleService'; // Import your service
          ...
          <div className="px-6 py-4 border-t border-neutral-100">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-sm text-neutral-600 font-cairo">
                ...
                <span className="font-medium">{(pageNumber + 1) * size}</span> of{' '}
